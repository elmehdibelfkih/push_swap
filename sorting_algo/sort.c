...
/*   Updated: 2023/05/08 05:06:02 by ebelfkih         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	small_sort_5(t_list **stack_a, t_list **stack_b, t_vars *m)
{
	...
	while (tmp)
	{
		if (tmp->final_pos == 5)
		{
			if (tmp->pos == 3 || tmp->pos == 2)
			{
				if (tmp->pos == 3)
					operation(stack_a, stack_b, m, "ra");
				operation(stack_a, stack_b, m, "sa");
			}
			else if (tmp->pos == 4 || tmp->pos == 5)
			{
				operation(stack_a, stack_b, m, "rra");
				if (tmp->pos == 5)
					operation(stack_a, stack_b, m, "rra");
	...
	operation(stack_a, stack_b, m, "pb");
	return (small_sort_4(stack_a, stack_b, m), operation(stack_a,
			stack_b, m, "pa"), operation(stack_a, stack_b, m, "ra"));
}
