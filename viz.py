...
class PsGui:
    def __init__(self, master):
        ...
        if len(self.pile_a) != 0:
            ...
            self.prespeed = 0
        self.master = master
        master.title("Push_swap viewer (Pulga Version)")
        self.mainframe = Frame(master)
        self.mainframe.pack(fill=BOTH)
        self.can = Canvas(self.mainframe, width=ww, height=wh, bg="pink")
        ...
        self.listbox = Listbox(self.toolframe, bg='white', fg='black',
